...
use reth_primitives_traits::{logs_bloom, SignedTransaction};
...
where
    F: for<'a> BlockExecutorFactory<ExecutionCtx<'a> = EthBlockExecutionCtx<'a>>,
    F::Transaction: SignedTransaction + Encodable2718,
    F::Receipt: TxReceipt<Log = Log> + Encodable2718,
